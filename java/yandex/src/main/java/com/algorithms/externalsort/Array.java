package com.algorithms.externalsort;
...
public class Array extends AbstractSequence {
     ...
     *  <CODE>SLList</CODE>.
     */
    public Array(final com.algorithms.externalsort.Iterator b, final com.algorithms.externalsort.Iterator e) {
        this(10, 10) ;
        copy(b, e) ;
    }
    /**
    ...
    public class Iterator implements RandomAccessIterator {
         ...
         */
        public boolean equals(final com.algorithms.externalsort.Iterator i) {
