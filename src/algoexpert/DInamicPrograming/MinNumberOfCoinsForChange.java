...
//n representing a target amount of money, write a function that returns the smallest number of coins needed
//to make change for (to sum up to) that target amount using the given coin denominations.
//
