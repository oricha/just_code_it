 ...
 */
public class PostOrderIteratorSetOfVisited {
    private Stack<Node> stack = new Stack<>();
    private Set<Node> visited = new HashSet<>();

    public PostOrderIteratorSetOfVisited(Node root) {
        stack.push(root);
    }
    ...
    public static void main(String[] args) {
        ...
        PostOrderIteratorSetOfVisited it = new PostOrderIteratorSetOfVisited(n);
        Node next;
