...
/**
 * Test for Fork-join framework (jdk7). Shows, that FJ is useful with big data
 * with some non-trivial operations with it (simple n * n is very good when used
 * linearly) and FJ does not "win" for this cases..
 * 
 */
